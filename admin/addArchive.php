 ...
 *
 * @file biocasemonitor/admin/addArchive.php
 * @brief backend: add an XML Archive
 *
...
try {
    $sql = "SELECT max(position) as maxpos FROM archive "
    ...
    $sql = "INSERT INTO archive "
            ...
            . "('$newPosition','$providerId','$collectionId','BioCASe Archive','') ";
    if (DEBUGMODE) {
        $result["info"] .= $sql;
    }
    $stmt = $db->query($sql);
    ...
    // GET ID
    $sql = "SELECT id as newId FROM archive "
