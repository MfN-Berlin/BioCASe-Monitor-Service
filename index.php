    ...
    <nav class="navbar  navbar-default">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li>
                    <a href="#" id="verbose-control" class="glyphicon glyphicon-eye-open" title="show/hide progress bars"> on</a>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a id="footer-control" href="#" title="Legal Infos" class="glyphicon glyphicon-info-sign"> Legal</a></li>
            </ul>
        </div>
    </nav>
        ...
        <ul class="impressum">
            ...
            <li class="menuItem">
                <figure>
                    ...
                    <a href="https://www.museumfuernaturkunde.berlin" title="https://www.museumfuernaturkunde.berlin" target="_blank">
