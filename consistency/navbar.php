    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            if (CUSTOM == "1") {
                ...
                echo "<figure><a href='$custom_institution' target='_blank'><img src='../$custom_logo' alt='$custom_institution_shortname' style='height:55px;padding-left:20px;padding-right:20px;'/></a>
</figure>";
            }
            ?>
        </div>
