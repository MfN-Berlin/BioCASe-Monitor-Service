 ...
 *
 * @file biocasemonitor/config/config.prod.php
 * @brief configuration for PRODUCTION MODE:  constants and DB settings
 *
...
//define("DB_DIR", "/local/apache/biocasemonitor/db/db_gfbio/");
