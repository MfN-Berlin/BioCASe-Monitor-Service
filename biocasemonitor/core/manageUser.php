 ...
 *
 * @file biocasemonitor/core/manageUser.php
...
<html lang="en">
    ...
    <body>
        ...
        if ($_POST && $_POST["formsent"]) {
            ...
            <script>
                //console.log('User Profile Manager');

                $("#menuInfo").html('User Profile Manager');
                ...
                if (hasError == 1) {
                    ...
                    displaySystemMessage("<?php echo $infomessage ?>");
                }
            </script>
            <?php
        }
...
// GET USER PROFILE(S)
        ...
        <script>
            $(document).ready(function () {
                //$("#loginForm").html("<?php echo addslashes($authFormContent); ?>");
                $("#menuInfo").html('User Profile Manager');
            });
        </script>
