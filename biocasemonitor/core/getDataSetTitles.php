 ...
 *
 * @file biocasemonitor/core/getDataSetTitles.php
...
/*
  ...
  <xsl:template match="//biocase:scan">
  <select id="ds_title_selectbox' . $dsa . '" name="ds[' . $dsa . '][dataset]" >
  <xsl:text>&#xa;</xsl:text>
  <option value="">---</option>
  <xsl:for-each select="//biocase:value">
